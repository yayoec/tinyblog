...
INSERT INTO `tinyblog_contents` (`id`, `title`, `meta_id`, `created`, `modified`, `content`, `order`, `author_id`, `summary`, `type`, `status`, `password`, `comments_num`, `read_num`, `like_num`, `support_num`, `allow_comment`, `allow_ping`, `allow_feed`, `parent`) VALUES
